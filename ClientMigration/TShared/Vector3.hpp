...
namespace CommonUtilities
{
	...
	public:
		...
		Vector3<T> RotateX(const double aRad); //Should return reference?
		Vector3<T> RotatedX(const double aRad) const; 
		Vector3<T> RotateAroundPointX(const Vector3<T>& aVector, const double aRad); 
		Vector3<T> RotatedAroundPointX(const Vector3<T>& aVector, const double aRad) const; 

		Vector3<T> RotateY(const double aRad); 
		Vector3<T> RotatedY(const double aRad) const; 
		Vector3<T> RotateAroundPointY(const Vector3<T>& aVector, const double aRad);
		Vector3<T> RotatedAroundPointY(const Vector3<T>& aVector, const double aRad) const; 

		Vector3<T> RotateZ(const double aRad); 
		Vector3<T> RotatedZ(const double aRad) const; 
		Vector3<T> RotateAroundPointZ(const Vector3<T>& aVector, const double aRad); 
...
#pragma region Operators
	...
	inline Vector3<T> operator/=(Vector3<T> &aVector, const T aScalar)
	{
		...
		double divNum = 1.0 / static_cast<T>(aScalar);
...
#pragma region Rotate X
	template<class T>
	inline Vector3<T> Vector3<T>::RotateX(const double aRad)
	{
		double c = cos(aRad);
		double s = sin(aRad);
	...
	template<class T>
	inline Vector3<T> Vector3<T>::RotateAroundPointX(const Vector3<T>& aVector, const double aRad)
	{
		y -= aVector.y;
		z -= aVector.z;
		RotateX(aRad);
...
#pragma region Rotate Y
	template<class T>
	inline Vector3<T> Vector3<T>::RotateY(const double aRad)
	{
		double c = cos(aRad);
		double s = sin(aRad);
	...
	template<class T>
	inline Vector3<T> Vector3<T>::RotateAroundPointY(const Vector3<T>& aVector, const double aRad)
	{
		x -= aVector.x;
		z -= aVector.z;
		RotateY(aRad);
...
#pragma region Rotate Z
	template<class T>
	inline Vector3<T> Vector3<T>::RotateZ(const double aRad)
	{
		double c = cos(aRad);
		double s = sin(aRad);
	...
	template<class T>
	inline Vector3<T> Vector3<T>::RotateAroundPointZ(const Vector3<T>& aVector, const double aRad)
	{
		x -= aVector.x;
		y -= aVector.y;
		RotateZ(aRad);
